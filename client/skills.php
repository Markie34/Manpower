...
<div class="container">
  <ul class="timeline">
    ...
    <li class="active-tl"><strong>Skills</strong></li>
    <li>Cover Letter</li>
                ...
                <div class="col">
                    ...
                    <div class="card">
                        <div class="card-body p-4">
                            <h5 class="text-center">SKILLS</h5><hr>
                            <form action="../admin/function.php" method="POST" onsubmit="collectSkills()">
    <input type="hidden" name="job_id" value="<?php echo $_GET['id'];?>">
    <input type="hidden" id="skillsInput" name="skills"> <!-- Hidden input field to store skills -->
    <div class="container">
        <div class="row">
            <div class="col">
                <div class="input-group">
                    <input type="text" id="textInput" class="form-control" placeholder="Enter Skill">
                    <button onclick="addText()" class="btn btn-primary" type="button">Type your Skill</button>
                </div>
                <div id="textContainer" class="pt-3"></div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col">
            <div style="float:right;">
                <button type="submit" name="apply_skill" class="btn btn-primary">Next</button>
            </div>
        </div>
    </div>
</form>
...
function addText() {
    ...
    if(text.trim() !== "") {
        ...
        document.getElementById("textContainer").appendChild(badge);
...
function collectSkills() {
    var skills = [];
    var badges = document.querySelectorAll(".badge-primary");
    badges.forEach(function(badge) {
        skills.push(badge.textContent);
    });
