...
<div class="container">
  <ul class="timeline">
    <li class="active-tl"><strong>Basic Information</strong></li>
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <label for="" class="pt-3">Middle Name</label>
                                    <input type="text" name="middlename" class="form-control" placeholder="Middle Name">

                                    <label for="" class="pt-3">Last Name</label>
                                    <input type="text" name="lastname" class="form-control" placeholder="Last Name">
                               
                                    <label for="gender" class="form-label pt-3">Gender</label>
                                ...
                                <label for="contact" class="form-label pt-3">Contact</label>
                                <input type="text" class="form-control" placeholder="Contact Number" name="contact" required>
                                
                            

                                <label for="contact" class="form-label pt-3">Address</label>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <button type="submit" name="apply" class="btn btn-primary">Next</button>
